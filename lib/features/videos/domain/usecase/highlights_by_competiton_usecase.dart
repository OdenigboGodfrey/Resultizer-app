...
class HighlightByCompetitionUseCase implements UseCase<List<ScorebatVideoModel>, String> {
  final ScorebatRepository scorebatRepository;

  HighlightByCompetitionUseCase({required this.scorebatRepository});
  
  @override
  Future<Either<Failure, List<ScorebatVideoModel>>> call(String competition) async {
    return await scorebatRepository.getHighlightsByCompetition(competition);
  }
}